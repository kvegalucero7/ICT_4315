...
import ict4305.university.parking.charges.factory.ParkingChargeStrategyFactoryImpl;
...
class TransactionManagerTest {
	...
	@Test
	public void testCalculateHourlyCharge() {
		ParkingChargeStrategyFactoryImpl factory = new ParkingChargeStrategyFactoryImpl();
		ParkingLot lot = new ParkingLot("Lot 1", new Money(500), factory);
		
		LocalDateTime entryTime = LocalDateTime.of(2025, 4, 1, 9, 0);
		LocalDateTime exitTime = LocalDateTime.of(2025, 4, 1, 11, 30);
		Car car = new Car("123ABC", CarType.COMPACT, new Customer("CI00001", "Alice"));
