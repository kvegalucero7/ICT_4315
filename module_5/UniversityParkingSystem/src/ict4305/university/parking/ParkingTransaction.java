...
public class ParkingTransaction {
	...
	private Car car; //charge is part of new code
	////
	
	public ParkingTransaction(LocalDateTime entryTime, LocalDateTime exitTime, Car car, Money charge) {
		if(entryTime == null || exitTime == null || car == null || charge == null) {
	...
	}*/ //removed to try new code
	
	
	////// This can possibly be removed now that strategies are in place
	...
	// Return string with details on parking transaction
	@Override
	public String toString() {
		return "ParkingTransaction--[entryTime=" + entryTime + 
				", exitTime=" + exitTime +
				", permit=" + permit + 
				", lot=" + lot + 
				", charge=" + charge + "]";
